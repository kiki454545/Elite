        ...
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white">
              {language === 'fr' ? 'Classement des Votes' : 'Vote Ranking'}
            </h1>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 pb-24">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <XPBadge xp={profile.vote_score} size="sm" />
                    </div>
        ...
        >
          ...
          <p className="text-sm text-gray-300 mb-3">
            {language === 'fr'
              ? 'Votez pour vos profils préférés ! Plus un profil reçoit de votes, plus il monte dans le classement et débloque des badges.'
              : 'Vote for your favorite profiles! The more votes a profile receives, the higher it ranks and unlocks badges.'}
          </p>
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="text-sm bg-yellow-500/20 text-yellow-400 px-3 py-1 rounded-full">🥇 Top 1</span>
            <span className="text-sm bg-gray-500/20 text-gray-300 px-3 py-1 rounded-full">🥈 Top 2</span>
            <span className="text-sm bg-amber-500/20 text-amber-400 px-3 py-1 rounded-full">🥉 Top 3</span>
