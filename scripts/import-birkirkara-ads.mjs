...
async function importAds() {
  try {
    console.log('📥 Importation des annonces de Birkirkara...\n')

    const jsonPath = join(__dirname, '..', 'data', 'birkirkara-ads.json')
    ...
    for (let i = 0; i < jsonData.ads.length; i++) {
      ...
      try {
        ...
        // Email commence à 60 (après Msida qui va de 15 à 59)
        const email = `escortemalte${i + 60}@gmail.com`
...
console.log('🚀 Démarrage de l\'importation des annonces de Birkirkara...\n')
importAds()
