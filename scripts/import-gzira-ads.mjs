...
async function importAds() {
  try {
    console.log('📥 Importation des annonces de Gzira...\n')
    ...
    for (let i = 0; i < jsonData.ads.length; i++) {
      ...
      try {
        ...
        // Email commence à 108 (après Sliema qui va de 66 à 107)
        const email = `escortemalte${i + 108}@gmail.com`
...
console.log('🚀 Démarrage de l\'importation des annonces de Gzira...\n')
importAds()
