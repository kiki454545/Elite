...
async function importAds() {
  try {
    console.log('📥 Importation des annonces de La Valette...\n')

    const jsonPath = join(__dirname, '..', 'data', 'la-valette-ads.json')
    ...
    for (let i = 0; i < jsonData.ads.length; i++) {
      ...
      try {
        ...
        // Email commence à 150 (après Marsaskala qui va de 133 à 149)
        const email = `escortemalte${i + 150}@gmail.com`
...
console.log('🚀 Démarrage de l\'importation des annonces de La Valette...\n')
importAds()
