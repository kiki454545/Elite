...
console.log('🚀 Exécution de la migration pour les avertissements utilisateur...\n')

const sqlContent = fs.readFileSync('scripts/create_warnings.sql', 'utf8')
...
try {
  ...
  if (error) {
    ...
    console.log('   Car elle contient des commandes DDL (CREATE TABLE, CREATE INDEX, etc.)\n')
