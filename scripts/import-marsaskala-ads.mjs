...
async function importAds() {
  try {
    console.log('📥 Importation des annonces de Marsaskala...\n')
    ...
    for (let i = 0; i < jsonData.ads.length; i++) {
      ...
      try {
        ...
        // Email commence à 133 (après Gzira qui va de 108 à 132)
        const email = `escortemalte${i + 133}@gmail.com`
...
console.log('🚀 Démarrage de l\'importation des annonces de Marsaskala...\n')
importAds()
