...
async function addIpTracking() {
  try {
    console.log('🔧 Ajout du système de tracking IP...')

    // Lire le fichier SQL
    const sqlPath = join(__dirname, '..', 'supabase', 'migrations', '007_add_ip_tracking.sql')
    ...
    console.log('\n✅ Une fois la migration exécutée, le système de tracking IP sera actif!')
